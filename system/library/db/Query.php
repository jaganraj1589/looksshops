...
include DIR_SYSTEM.'library/db/Common/SchemaAnalyzer.php';
include DIR_SYSTEM.'library/db/Common/Conditions.php';
include DIR_SYSTEM.'library/db/Common/Order.php';
include DIR_SYSTEM.'library/db/Common/Limit.php';
include DIR_SYSTEM.'library/db/Operations/Join.php';
include DIR_SYSTEM.'library/db/Operations/Aggregates.php';
include DIR_SYSTEM.'library/db/Operations/Select.php';
include DIR_SYSTEM.'library/db/Operations/Insert.php';
include DIR_SYSTEM.'library/db/Operations/Update.php';
include DIR_SYSTEM.'library/db/Operations/Delete.php';
